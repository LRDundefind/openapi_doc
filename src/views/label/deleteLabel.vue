<template>
    <div class="group">
        ...
        <!-- 转换json格式组件 -->
        <json-viewer :data="labelData2" :id-name="jsonId.jsonViewer1"></json-viewer>
        ...
        <json-viewer :data="labelData3" :id-name="jsonId.jsonViewer2"></json-viewer>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                jsonId: {
                    jsonViewer1: "labelData2",
                    jsonViewer2: "labelData3"
                },
