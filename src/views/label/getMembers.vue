<template>
    <div class="group">
        ...
        <!-- 转换json格式组件 -->
        <json-viewer :data="obtainData" :id-name="jsonId.jsonViewer1"></json-viewer>
        ...
        <json-viewer :data="obtainData1" :id-name="jsonId.jsonViewer2"></json-viewer>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                jsonId: {
                    jsonViewer1: "obtainData",
                    jsonViewer2: "obtainData1"
                },
