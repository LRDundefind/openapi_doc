<template>
    <div class="group">
        ...
        <!-- 转换json格式组件 -->
        <json-viewer :data="labelData" :id-name="jsonId.jsonViewer1"></json-viewer>
        ...
        <json-viewer :data="labelData1" :id-name="jsonId.jsonViewer2"></json-viewer>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                jsonId: {
                    jsonViewer1: "labelData",
                    jsonViewer2: "labelData1"
                },
