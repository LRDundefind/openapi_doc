<template>
    <div class="group">
        ...
        <!-- 转换json格式组件 -->
        <json-viewer :data="departmentData2" :id-name="jsonId.jsonViewer1"></json-viewer>
        ...
        <json-viewer :data="departmentData3" :id-name="jsonId.jsonViewer2"></json-viewer>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                jsonId: {
                    jsonViewer1: "departmentData2",
                    jsonViewer2: "departmentData3"
                },
